//package com.mt.examples.fs;
	...
	public class IT114deliverable1client {
		Socket server;
		public IT114deliverable1client() {
		}
					...
					public void run() {
						try {
							while(!server.isClosed()) {
								System.out.println("You may offer an input");
		...
		public static void main(String[] args) {
			IT114deliverable1client client = new IT114deliverable1client();
			int port = -1;
			try{
